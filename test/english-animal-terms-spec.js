...
describe('English Animal Terms Table', () => {
  ...
  it('should parse table data', () => {
    ...
    properties.tables[0][3].collectiveNoun.should.equal(
      'army,colony,nest,swarm'
    );
    properties.tables[0][170].subject.should.equal('wildfowl');
    properties.tables[0][170].collectiveNoun.should.equal(
      'bunch,knob,plump,trip'
    );
  });
});
